...
function IntroSlide( props ) {
    const { image, title="This is the title", subtitle="This is the subtitle", subtitleAdClass="text-primary", price="$150", btnText = "Shop More" } = props.data;
    let back = process.env.REACT_APP_API_URL + 'media/' + image;
