...
function Cart( props ) {
    ...
    const shippingPrice = { "free": 0, "standard": 120 };
    ...
    return (
        <>
            <Helmet>
                <title>Mobile Hut Store | Shopping Cart</title>
            </Helmet>

            <h1 className="d-none">Mobile Hut Store - Shopping Cart</h1>
                                                ...
                                                cartlist.map( ( item, index ) =>
                                                    <tr key={ 'cart-item-' + index }>
                                                        <td className="product-col">
                                                            <div className="product">
                                                                <figure className="product-media">
                                                                    <Link to={ `${process.env.PUBLIC_URL}/product/default/${item.product_id}` }>
                                                                        <img src={process.env.REACT_APP_API_URL + 'media/' + item.product_images[ 0 ].image + '/' } alt="Product" />
                                                                    </Link>
                                                                </figure>

                                                                <h3 className="product-title">
                                                                    <Link to={ `${process.env.PUBLIC_URL}/product/default/${item.product_id}` }>{ item.product_name }</Link>
                                                                </h3>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="quantity-col" id={'quantity-input-wrapper-' + index}>
                                                            <div className="cart-product-quantity" onClick={ ( e ) => onChangeQty( e, item.product_id ) }>
                                                                <input type="number"
                                                        ...
                                                        <td className="total-col">
                                                            Rs.{ item.sum.toLocaleString( undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 } ) }
                                                        </td>

                                                        <td className="remove-col">
                                                            <button className="btn-remove" onClick={ ( e ) => removeFromCart( item.product_id ) }><i className="icon-close"></i></button>
                                                        </td>
                                                    </tr>
                                                ) :
                                                <tr>
                                        ...
                                        <table className="table table-summary">
                                            ...
                                            {total>2000?
                                                ...
                                                <tr className="summary-total">
                                                    <td>Total:</td>
                                                    {total<=2000?<td>
                                                        Rs.{ ( total + 120 ).toLocaleString( undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 } ) }
                                                    </td>:<td>
                                                        Rs.{ ( total + 0 ).toLocaleString( undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 } ) }
                                                    </td>}
                                                </tr>
                                            </tbody>
                                        </table>
